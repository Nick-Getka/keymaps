...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,   SGUI(KC_LEFT), G(KC_D), SGUI(KC_RIGHT), S(KC_GRV), S(KC_1),  S(KC_5), S(KC_3),  ANGLE,     DOT,         S(KC_7),        _______,
    _______,   _______,       _______, _______,        _______, _______,  _______, _______, G(KC_TAB), G(KC_SPACE), G(A(KC_SPACE)), SGUI(KC_TAB)
),

/* Raise
 * ,-----------------------------------------------------------------------------------.
 * | UTab |TLeft |NewTab|TRight|VSCode|      | All  |Save  |   1  |   2  |   3  | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |CloseT|Tools |Reload| Term |      | Redo | Undo |   4  |   5  |   6  |  0   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |CloseW|NewWin|Chrome|      |      |      |      |   7  |   8  |   9  |  .   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |DLeft | DUp  |DDown |DRight|
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_planck_grid(
    S(KC_TAB), C(S(KC_TAB)), G(KC_T),    C(KC_TAB), VSCODE,  _______, G(KC_A),    G(KC_S), KC_1,          KC_2,        KC_3,           KC_DEL,
    _______,   G(KC_W),      G(A(KC_I)), G(KC_R),   TERM,    _______, SGUI(KC_Z), G(KC_Z), KC_4,          KC_5,        KC_6,           KC_0,
    _______,   G(S(KC_W)),   G(KC_N),    CHROME,    _______, _______, _______,    _______, KC_7,          KC_8,        KC_9,           KC_DOT,
